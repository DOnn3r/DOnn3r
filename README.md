...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-000000?style=flat-square&logo=linkedin&logoColor=white)](https://linkedin.com/in/nomena-rasandifera-8361a1299)
[![Gmail](https://img.shields.io/badge/Email-000000?style=flat-square&logo=gmail&logoColor=white)](mailto:rasandiferapro@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-000000?style=flat-square&logo=github&logoColor=white)](https://github.com/DOnn3r)
...
I build interfaces and APIs as part of my studies and personal projects.  
My playground: front-end with **React / Next.js**, and back-end with **Java / Spring Boot**.  
Still learning, but curious and consistent.

- 🎓 L3 Computer Science @ HEI Madagascar *(2023 – 2026)*
- 🌍 Based in Antananarivo, Madagascar
- 📜 DELF B2 — French proficiency certificate
- 🔍 Open to **internship or work-study** opportunities
...
|---------|-------------|-------|
| [tapakila-admin](https://github.com/DOnn3r/tapakila-admin) | Admin dashboard for an online ticket booking app | React · TypeScript · Vite |
| [Fiscal_center_API](https://github.com/DOnn3r/Fiscal_center_API) | REST API centralizing fiscal centers across Madagascar | Java · Spring Boot · PostgreSQL |
| [roof-pitch](https://github.com/MitsoaAllan/roof-pitch) | API for automatic roof slope calculation | Java · Spring Boot |
| [managem-app](https://github.com/Sedera0/managem-app) | Personal budget management interface | JavaScript · React.js |
